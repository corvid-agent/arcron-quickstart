#!/usr/bin/env python3
"""Recreate MinimalTarget (quickstart) on AlgoKit LocalNet and write docs/localnet.json.
...
CONTRACT = ROOT / "contracts" / "minimal_target.py"
ARTIFACT_DIR = ROOT / "contracts"
...
CONTRACT_NAME = "MinimalTarget"
SOURCE = "contracts/minimal_target.py"
...
def main() -> None:
    ...
    txn = ApplicationCreateTxn(
        ...
        app_args=[],  # MinimalTarget: bare NoOp create (no create() method)
        extra_pages=extra,
    )
